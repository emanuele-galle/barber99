...
export function AppointmentActions({ appointmentId, currentStatus, clientEmail, clientName }: AppointmentActionsProps) {
      ...
      {showMenu && (
        <>
          ...
          <div className="absolute right-0 top-full mt-1 z-20 w-56 bg-[#1a1a1a] border border-[rgba(212,168,85,0.15)] rounded-lg shadow-xl overflow-hidden admin-fade-in">
            ...
            {currentStatus !== 'noshow' && currentStatus !== 'cancelled' && currentStatus !== 'completed' && (
              <button
